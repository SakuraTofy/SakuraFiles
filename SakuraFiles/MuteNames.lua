...
if DevSakura:get(SAKURA.."Sakura:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevSakura:sadd(SAKURA.."Sakura:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevSakura:srem(SAKURA.."Sakura:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevSakura:del(SAKURA.."Sakura:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌔︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevSakura:smembers(SAKURA.."Sakura:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevSakura:get(SAKURA.."Sakura:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
SAKURAName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if SAKURAName then 
SAKURANames = DevSakura:smembers(SAKURA.."Sakura:Mute:Names"..msg.chat_id_) or ""
if SAKURANames and SAKURANames[1] then 
for i=1,#SAKURANames do 
if SAKURAName:match("(.*)("..SAKURANames[i]..")(.*)") then 
...
DevSakura:set(SAKURA.."Sakura:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevSakura:del(SAKURA.."Sakura:Lock:MuteNames"..msg.chat_id_)
end
end
end
