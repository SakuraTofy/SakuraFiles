...
if result.id_ then 
local abbs = DevSakura:get("SAKURATEAM:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevSakura:del("SAKURATEAM:Name"..result.id_) 
end
end
...
DevSakura:set("SAKURATEAM:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
